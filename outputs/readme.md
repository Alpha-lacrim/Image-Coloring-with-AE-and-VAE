...
OUTPUT FILES
----------------------------------------
  ok phase1_dataset_samples.png
  X phase2_ae_training_curves.png
  ok phase2_ae_results.png
  ok phase3_vae_training_curves.png
  ok phase3_vae_diversity.png
  ok phase3_vae_latent_space.png
  ok phase4_comparison_collage.png
  ok phase4_metrics_comparison.png
  ok phase4_best_worst.png
  ok report_summary.txt
